...
function apiDocumentEndpoints(app) {
  ...
  app.post(
    ...
    #swagger.description = 'Upload a new file to DocCursor to be parsed and prepared for embedding, with optional metadata.'
    #swagger.requestBody = {
  ...
  app.post(
    ...
    async (request, response) => {
      /*
      #swagger.tags = ['Documents']
      #swagger.description = 'Upload a new file to a specific folder in DocCursor to be parsed and prepared for embedding. If the folder does not exist, it will be created.'
  ...
  app.post(
    ...
    async (request, response) => {
      /*
    #swagger.tags = ['Documents']
    #swagger.description = 'Upload a valid URL for DocCursor to scrape and prepare for embedding. Optionally, specify a comma-separated list of workspace slugs to embed the document into post-upload.'
    #swagger.requestBody = {
              ...
              documents: [
                {
                  ...
                  "wordCount": 252,
                  "pageContent": "DocCursor is the best....",
      ...
      content: {
        "application/json": {
          schema: {
            type: 'object',
            example: {
              "textContent": "This is the raw text that will be saved as a document in DocCursor.",
              "addToWorkspaces": "workspace1,workspace2",
              "metadata": {
  ...
  app.get("/v1/document/:docName", [validApiKey], async (request, response) => {
    /*
    #swagger.tags = ['Documents']
    #swagger.description = 'Get a single document by its unique DocCursor document name'
