...
const TRANSLATIONS = {
  onboarding: {
    survey: {
      ...
      useCase: "Waarvoor ga je DocCursor gebruiken?",
      useCaseWork: "Voor werk",
      useCasePersonal: "Voor persoonlijk gebruik",
      useCaseOther: "Anders",
      comment: "Hoe heb je over DocCursor gehoord?",
      commentPlaceholder:
      ...
      title: "Welkom bij DocCursor",
      description:
        "Help ons DocCursor af te stemmen op jouw behoeften. (Optioneel)",
    },
    home: {
    ...
    llm: {
      ...
      description:
        "DocCursor kan samenwerken met veel LLM-aanbieders. Deze service verzorgt de chatfunctie.",
    },
    userSetup: {
  ...
  settings: {
    ...
    chat: "Chat",
    "mobile-app": "DocCursor Mobiele App",
    "community-hub": {
      title: "Centraal punt",
  ...
  general: {
    ...
    message: {
      ...
      heading: "Leg me uit",
      body: "de voordelen van DocCursor",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Betaling",
        description:
          'Maak gebruik van een onbeperkt aantal tools en verminder het gebruik van "cut tokens" met tot wel 80% per query – DocCursor selecteert automatisch de juiste vaardigheden voor elke vraag.',
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  api: {
    title: "API-sleutels",
    description:
      "API-sleutels stellen de houder in staat om deze DocCursor-instantie programmatisch te openen en beheren.",
    ...
    modal: {
      ...
      helper:
        "Na het aanmaken kan de API-sleutel worden gebruikt om programmatisch toegang te krijgen tot deze DocCursor-instantie en deze te configureren.",
      name: {
        label: "Naam",
  ...
  llm: {
    title: "LLM Voorkeur",
    description:
      "Dit zijn de inloggegevens en instellingen voor je voorkeurs LLM-chat & inbeddingprovider. Het is belangrijk dat deze sleutels actueel en correct zijn, anders zal DocCursor niet goed werken.",
  ...
  transcription: {
    ...
    "warn-start":
      "Het gebruik van het lokale fluistermodel op machines met beperkte RAM of CPU kan DocCursor vertragen bij het verwerken van mediabestanden.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Inbedding is het proces van het omzetten van tekst in vectoren. Deze inloggegevens zijn vereist om je bestanden en prompts om te zetten naar een formaat dat DocCursor kan gebruiken om te verwerken.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Dit zijn de inloggegevens en instellingen voor hoe je DocCursor-instantie zal functioneren. Het is belangrijk dat deze sleutels actueel en correct zijn.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Dit is je configuratie voor hoe verbonden derden en DocCursor je gegevens verwerken.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Deze bestanden worden geüpload naar de documentverwerker die op deze DocCursor-instantie draait. Deze bestanden worden niet verzonden naar of gedeeld met derden.",
    },
    pinning: {
      what_pinning: "Wat is het vastzetten van documenten?",
      pin_explained_block1:
        "Wanneer u een document vastzet in DocCursor, injecteren we de volledige inhoud van het document in uw promptvenster, zodat uw LLM het volledig kan begrijpen.",
      ...
      pin_explained_block3:
        "Als u standaard niet de gewenste antwoorden krijgt van DocCursor, is vastzetten een uitstekende manier om met één klik antwoorden van hogere kwaliteit te krijgen.",
      accept: "Oké, begrepen.",
    },
    watching: {
      what_watching: "Wat doet het volgen van een document?",
      watch_explained_block1:
        "Wanneer u een document in DocCursor volgt, synchroniseren we de inhoud van uw document automatisch met regelmatige tussenpozen vanuit de originele bron. Hierdoor wordt de inhoud in elke werkruimte waar dit bestand wordt beheerd automatisch bijgewerkt.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Geheugen",
        placeholder:
          "bijvoorbeeld: De naam van de gebruiker is Joe, de gebruiker werkt aan DocCursor, enz.",
        create: "Creëren",
        save: "Opslaan",
        cancel: "Annuleren",
      },
  ...
  customization: {
    interface: {
      title: "UI-voorkeuren",
      description: "Stel uw UI-voorkeuren in voor DocCursor.",
    },
    branding: {
      title: "Branding & Whitelabeling",
      description:
        "Geef uw DocCursor-instantie een whitelabel met uw eigen branding.",
    },
    chat: {
      title: "Chat",
      description: "Stel uw chatvoorkeuren in voor DocCursor.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "Weergavetaal",
        description:
          "Selecteer de gewenste taal waarin de gebruikersinterface van DocCursor moet worden weergegeven - wanneer vertalingen beschikbaar zijn.",
      },
      logo: {
        title: "Merklogo",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Bescherm je DocCursor-instantie met een wachtwoord. Als je dit vergeet, is er geen herstelmethode, dus zorg ervoor dat je dit wachtwoord opslaat.",
  ...
  telegram: {
    title: "Telegram Bot",
    description:
      "Verbind uw DocCursor-instantie met Telegram, zodat u vanuit elk apparaat kunt communiceren met uw werkruimtes.",
    setup: {
      step1: {
