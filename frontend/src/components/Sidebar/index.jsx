    ...
    <>
      ...
      >
        ...
        <div className="overflow-hidden h-full">
          ...
          <div
            ref={sidebarRef}
            className="relative mx-[8px] bg-theme-bg-sidebar min-w-[258px] p-[10px] h-[calc(100%-76px)]"
          >
            <div className="flex flex-col h-full overflow-hidden">
              <div className="flex-grow flex flex-col min-w-[235px] min-h-0">
                ...
                <div className="absolute bottom-0 left-0 right-0 pb-3 bg-theme-bg-sidebar bg-opacity-80 backdrop-filter backdrop-blur-md z-10">
                  <Footer />
                </div>
              </div>
            </div>
