...
import DocCursorLogo from "./media/logo/doccursor.png";
import DocCursorLogoDark from "./media/logo/doccursor-dark.png";
  ...
  async function fetchInstanceLogo() {
    ...
    try {
      ...
      if (logoURL) {
        ...
        isLightMode() ? setLogo(DocCursorLogoDark) : setLogo(DocCursorLogo);
